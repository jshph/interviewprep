...
class ParsedUrl(object):
  ...
  def parse_from_string(input):
    ...
    for kwarg in orderAndPath[1].split('&'):
      ...
      try:
      # assuming that numbers that can be reprsented as integers don't overflow...
...
def main(argv):
  ...
  print ParsedUrl.parse_from_string("sftp://www.subdomain.actual.com:8888/?keyword=awesome&secondkey=123456789")
