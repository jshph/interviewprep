...
class ParsedUrl(object):
  ...
  # ASSUMPTION: "string fields only contain alphanum characters" in description means the URL is well formed, but
  # URL parameters may represent encoded, space-separated strings. >> support spaces.
...
def main(argv):
  ...
  print ParsedUrl.parse_from_string("sftp://www.subdomain.actual.com:8888/?keyword=awesome&secondkey=123asdfa81214")
